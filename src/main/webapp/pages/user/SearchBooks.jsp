...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/SearchBooks.css" />
</head>
<body>
  <header class="navbar">
    <div class="logo">
    ...
    <nav>
      <ul class="nav-links">
        ...
        <li><a href="${pageContext.request.contextPath}/pages/user/SearchBooks.jsp">Books</a></li>

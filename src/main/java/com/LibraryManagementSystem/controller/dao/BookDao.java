package com.LibraryManagementSystem.controller.dao;
...
import com.LibraryManagementSystem.controller.database.DatabaseConnection;
import com.LibraryManagementSystem.controller.model.Book;
...
public class BookDao {
    ...
    public boolean addBook(Book book) throws SQLException {
        ...
        try (PreparedStatement ps = con.prepareStatement(query)) {
            ...
            return ps.executeUpdate() > 0;  // Return true if the insert is successful
    ...
    public int getAvailableCopies(int bookId) throws SQLException {
        String sql = 
                "SELECT b.total_copies - COUNT(br.book_id) AS available_copies " +
                "FROM book b LEFT JOIN borrow_record br ON b.book_id = br.book_id AND br.return_date IS NULL " +
                "WHERE b.book_id = ? GROUP BY b.book_id, b.total_copies";

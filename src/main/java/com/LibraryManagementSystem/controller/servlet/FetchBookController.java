...
import com.LibraryManagementSystem.controller.dao.BookDao;
...
@WebServlet("/FetchBookController")
public class FetchBookController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Forward to JSP
        request.getRequestDispatcher("/pages/user/Books.jsp").forward(request, response);
    }
}
